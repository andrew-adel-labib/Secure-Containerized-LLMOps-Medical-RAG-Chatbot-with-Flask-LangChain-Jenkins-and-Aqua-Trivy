pipeline {
    ...
    environment {
        ...
        ECR_REPO = 'andrew-repo'
        IMAGE_TAG = 'latest'
        SERVICE_NAME = 'llmops-medical-chatbot-service'
    }
        ...
        stage('Clone GitHub Repo') {
            steps {
                script {
                    ...
                    checkout scmGit(branches: [[name: '*/main']], extensions: [], userRemoteConfigs: [[credentialsId: 'github-token', url: 'https://github.com/andrew-adel-labib/Secure-Containerized-LLMOps-Medical-RAG-Chatbot-with-Flask-LangChain-Jenkins-and-Aqua-Trivy.git']])                }
            }
        }
